  ...
  return (
    <div>
      ...
      <div className='flex items-center justify-between m-1'>
        ...
        variant={"ghost"} 
        className='flex items-center gap-1 roundeg-lg text-gray-600 hover:text-black'>
          <ThumbsUp 
        ...
        <Button variant={"ghost"} className='flex items-center gap-1 roundeg-lg text-gray-600 hover:text-black'>
          <Repeat />
          <p>Repost</p>
        </Button>
        <Button variant={"ghost"} className='flex items-center gap-1 roundeg-lg text-gray-600 hover:text-black'>
